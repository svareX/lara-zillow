  ...
  <form @submit.prevent="create">
    <div class="grid grid-cols-6 gap-4">
      <div class="col-span-2">
        ...
        <input v-model.number="form.beds" type="number" class="input" max="255" />
      ...
      <div class="col-span-2">
        ...
        <input v-model.number="form.baths" type="number" class="input" max="255" />
      ...
      <div class="col-span-2">
        ...
        <input v-model.number="form.area" type="number" class="input" max="65535" />
      ...
      <div class="col-span-2">
        ...
        <input v-model.number="form.street_nr" type="number" class="input" />
